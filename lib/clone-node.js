...
function cloneCanvasElement(canvas) {
    return __awaiter(this, void 0, void 0, function () {
        var dataURL, out, data, webglDataURL;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    data = out.getImageData(0, 0, out.canvas.width, out.canvas.height);
                ...
                case 1:
                    webglDataURL = _a.sent();
                    return [2 /*return*/, (0, util_1.createImage)(webglDataURL)];
            }
        });
    });
}
